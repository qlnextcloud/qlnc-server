...
<a target="_blank" href="<?php p($_['ios']); ?>" class="conceal_class">
	<img src="<?php p(image_path('core', 'appstore.svg')); ?>"
		alt="<?php p($l->t('iOS app'));?>" style="height:60px"/>
</a>


<h2 class="conceal_class"><?php p($l->t('Connect your desktop apps to %s', array($theme->getName()))); ?></h2>
<a target="_blank" class="button conceal_class" href="<?php p(link_to_docs('user-sync-calendars')) ?>">
...
<a target="_blank" class="button conceal_class" href="<?php p(link_to_docs('user-sync-contacts')) ?>">
...
<a target="_blank" class="button conceal_class" href="<?php p(link_to_docs('user-webdav')); ?>">
	<img class="appsmall svg" alt=""
		src="<?php p(image_path('files', 'folder.svg')); ?>" />
	<?php p($l->t('Access files via WebDAV'));?>
</a>

<p class="footnote conceal_class">
