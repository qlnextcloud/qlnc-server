OC.L10N.register(
    ...
    "Password changed for %s" : "账号%s的密码已经被更改",
    ...
    "Email address changed for %s" : "账号%s的邮箱地址已经被更改",
    ...
    "Password format error, length 8-32 bits" : "密码格式错误，长度为8-32位",
    ...
    "Follow us on Google+!" : "在 Google+ 上关注我们!",
    "Follow us on Twitter!" : "在 Twitter 上关注我们!",
    "Group name format error, length 1-32 characters" : "组名格式错误，长度为1-32个字符",
    "Check out our blog!" : "浏览我们的博客！"
},
"nplurals=1; plural=0;");
